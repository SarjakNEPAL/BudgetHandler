    ...
    <body>
        <div class="banner">
            ...
            <div class="content">
                ...
                <div class="buttons">
                    <a href="../HTML/ear.php"><button type="button" disabled ><span class="butt"></span>Earnings</button></a>
                    <a href="../HTML/exp.php"><button type="button"><span class="butt"></span>Expenditures</button></a><br>
                    <a href="../HTML/bus1.php"><button type="button"><span class="butt" ></span>Business</button></a>
